...
export function CarruselDerecha({ category, highlighted, panelTitle = "Colección destacada" }) {
  ...
  const carouselId = `crs-right-${cat}-${highlighted ? "hi" : "all"}`;

  return (
    <div
      id={carouselId}
      className="carousel slide my-3 carousel-edge fade-right"
      data-bs-ride="carousel"      /* autoplay */
      data-bs-interval="3000"      /* cada 3s */
      data-bs-pause="hover"        /* pausa al pasar el mouse */
      data-bs-touch="true"
      data-bs-wrap="true"
    >
      {/* Panel fijo DERECHA */}
      <div className="promo-panel promo-right">
