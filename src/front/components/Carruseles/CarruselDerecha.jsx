// src/front/components/Carruseles/CarruselDerecha.jsx
...
export function CarruselDerecha({ category, highlighted }) {
  ...
  return (
    ...
    >
      ...
      <div className="ce-panel right" style={{ width: CARD_W, height: CARD_H }}>
        <img src="/publicidad2.png" alt="Colección destacada" />
      </div>
